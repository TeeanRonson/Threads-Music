...
public class SongInfoServlet extends BaseServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.println("<hr/>");
		out.println("<p><form method=\"post\" action=\"songinfo\"");
		...
		String artist = library.getByTrackId().get(trackId).getArtist();
		String title = library.getByTrackId().get(trackId).getTitle();
		
		JsonArray similars = new JsonArray();
		JsonObject object = new JsonObject();
		
		object = library.searchByTitle(title);
