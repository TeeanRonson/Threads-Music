...
public class ArtistServlet extends BaseServlet {
	...
	public void doGet(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		out.println("<p><a href=\"/home\">Home</a> <a href=\"/artist\">All Artists</a> <a href=\"history\"> History </a> <a href=\"logout\">Log out</a></p>");
		...
		for (JsonElement x: listOfArtists) {
			...
			out.println("<tr>");
			out.println("<td>" + "<a href=\"/artistinfo?artist=" + encodeA + "\">" + encodeA + "</a></td>");
